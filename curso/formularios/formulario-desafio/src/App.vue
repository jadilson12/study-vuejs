	...
	<div id="app">
		...
		<div class="conteudo">
			<form class="painel" v-if="!enviado">
				...
				<NomeCompleto v-model="nomeSobrenome"></NomeCompleto>
				<Rotulo nome="E-mail">
				...
				<Rotulo nome="Armazenar Dados">
					<input type="checkbox" v-model="amazenarDado">
				</Rotulo>
				<hr>
			...
			<div class="painel" v-else>
				...
				<Rotulo nome="Nome Completo">
					<span>{{ nomeSobrenome.nome }}</span>
				</Rotulo>
				<Rotulo nome="Sobrenome">
					<span>{{ nomeSobrenome.sobrenome }}</span>
				</Rotulo>
				<Rotulo nome="E-mail">
					<span>{{ email}}</span>
				</Rotulo>
